...
export default function ThesisPage({ params }: PageProps) {
  ...
  return (
    <motion.main
      ...
      style={{ minHeight: "100vh", background: "#06070b" }}
    >
      {/* ── Subtle exhibition room atmosphere ─────────────────────────── */}
      <div
      ...
      >
        <div
          style={{
            ...
            height: "500px",
            background:
              "radial-gradient(ellipse at 50% 0%, rgba(200, 160, 96, 0.025) 0%, transparent 70%)",
          }}
        />
      </div>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              height: "1px",
              background:
                "linear-gradient(90deg, rgba(200, 160, 96, 0.18) 0%, rgba(200, 160, 96, 0.06) 50%, transparent 100%)",
